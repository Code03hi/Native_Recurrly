...
const SubscriptionCard = ({name,price,currency,icon,billing,color,category,plan,renewalDate,onPress,onCancelPress,expanded,paymentMethod,startDate,status}:SubscriptionCardProps) => {
  return (
